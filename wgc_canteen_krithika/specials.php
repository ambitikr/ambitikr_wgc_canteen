...
$this_specials_query = "SELECT specials.SpecID, specials.Days, savoryitems.SavoryName, savoryitems.Stock, savoryitems.Cost, sweets.SweetName, sweets.Stock, sweets.Cost FROM specials, savoryitems, sweets 
WHERE specials.SavoryID = savoryitems.SavoryID 
AND specials.SweetID = sweets.SweetID AND specials.SpecID ORDER BY `specials`.`SpecID` ASC  = '"   .$id['specials']  . "'";
